...
const PropertyCard = ({ id, title, location, price, photo }: PropertyCardProps) => {
  return (
    <Card
      ...
      elevation={0}
    >
      <CardMedia component='img' width='100%' height={210}
        image={photo} alt='card image' sx={{ borderRadius: '10px' }} />
      <CardContent sx={{ display: 'flex', flexDirection: 'row', justifyConter: 'space-between', gap: '10px', paddingX: '5px' }}>
